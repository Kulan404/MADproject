...
class fetchingJobSeeker : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fetching_job_seeker)
                ...
                if (snapshot.exists()){
                    ...
                    mAdapter.setOnItemClickListener(object : jobAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            val intent = Intent(this@fetchingJobSeeker, job_details_seeker::class.java)
